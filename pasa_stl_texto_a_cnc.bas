...
open "ejemplo.cnc" for output as 2
...
while not eof(1)
    ...
    if yaobtenidos=3 then 
        ...
        print #2, "N1 X";sv(0);" Y";sv(1);" Z";sv(2)
        print #2, "N1 X";sv(3);" Y";sv(4);" Z";sv(5)
        print #2, "N1 X";sv(6);" Y";sv(7);" Z";sv(8)
                 
        ' Grabamos los vectores del triangulo del STL
        ' y los tres correspondientes para cerrar un triangulo
        ' NOTA: LO ANULO, POR QUE NO ES NECESARIO PARA LA PRUEBA QUE ESTOY HACIENDO
